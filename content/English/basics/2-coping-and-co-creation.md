...
[Table 2](7-two-contrasting-ontologies) shows the two separate ontologies of coping and co-creation. It organizes and relates the concepts within each ontology through matching them to complimentary concepts and/or roles in the other ontology. That we are able to do that on a consistent basis, suggests not only the structural differences between coping and co-creation, but also that we are uncovering some basic tenets of life and cognition.
...
In [section 3 "Identity"](/basics/3-identity-as-coping-and-co-creation-in-adequacy) of this paper we apply and extend the proposed framework to identity development and in [section 4 "Two routes to general well-being"](/basics/4-two-routes-to-general-well-being) we apply it on a metatheoretical level to two approaches to general well-being. Ontological security as manifestation of coping and psychological safety as manifestation of co-creation. This leads to the extension of [table 1](6-key-concepts) and [table 2]([Table 2](7-two-contrasting-ontologies)) and an improved definition of co-creation and the two ontologies that comprise it.

Next section is ["Identity as coping and co-creation adequacy"](/basics/3-identity-as-coping-and-co-creation-in-adequacy) 