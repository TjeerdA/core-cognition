...
{{< figure src="/images/life-challenging.gif" title="Figure 3. Dealing with Life's challenges" caption="Four attitudes toward problems and challenges (on the main axes), coupled with broad strategies (on the circle), effects on the world, and behavioral (in)effectiveness. The dashed arrows represent life’s key demands: maintaining and increasing viability of self and habitat (Part 1, Figure 1). Alternatively attending to both demands implements core cognition." width=100% >}}

![Figure 3. Dealing with Life's challenges](/images/life-challenging.gif width=100%  title="Figure 3. Dealing with Life's challenges" caption="Four attitudes toward problems and challenges (on the main axes), coupled with broad strategies (on the circle), effects on the world, and behavioral (in)effectiveness. The dashed arrows represent life’s key demands: maintaining and increasing viability of self and habitat (Part 1, Figure 1). Alternatively attending to both demands implements core cognition." "Figure 3. Dealing with Life's challenges")
...
<img src="https://corecognition.com/image/two-modes.png" alt="The two modes" style="zoom:50%" title="test" caption="Caption text."/>
