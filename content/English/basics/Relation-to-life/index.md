...
Seosection:
  title: "Core cognition is the cognitive science derived from life's defining properties"
  description : "Core cognition starts from the demands to being and remaining alive through maximizing viability of self and habitat. Here we derive its two main modes, coping and co-creation, from the defining properties of life."
  image_OG: ""

Header:
  heading: "1 - Core cognition derived from life's defining properties"
  summary: "In this first section we outline the basics of core cognition starting from the demands to being and remaining alive and maximizing viability of self and habitat. In it we derive core cognition and its two main modes, coping and co-creation, from the defining properties of life."
...
1. A [list  of key concepts](../CC-Key-Concepts)
2. Two [complementary ontologies](../CC-Two-Ontologies) one associated with coping, a second with co-creation
...
{{< figure src="need_satisfaction.png" title="Figure 1. Life’s demand" width=400 caption="Maintaining and increasing viability of self and habitat (based on Andringa & Angyal, 2019). Pervasive optimization of agent and habitat viability leads to increased carrying capacity and more life." >}}


<!--
<img src="need_satisfaction.png" alt="need_satisfaction" style="zoom: 50%;" />   
*Figure 1. Life’s demand: maintaining and increasing viability of self and habitat (based on Andringa & Angyal, 2019). Pervasive optimization of agent and habitat viability leads to increased carrying capacity and more life.* -->
...
{{< figure src="Behavioral-repertoire.png" title="Figure 2. Behavioral repertoire" width=700 caption="The concepts in the circle refer to appraisal and the verbs in italic to basic motivations. The descriptions in bold and the outer axes refer to the structure of behavioral (in)effectiveness." >}}

<!--
![Behavioral repertoire](Behavioral-repertoire.png)

*Core Figure 2 Behavioral repertoire. The concepts in the circle refer to appraisal and the verbs in italic to basic motivations. The descriptions in bold and the outer axes refer to the structure of behavioral (in)effectiveness.* -->

#### cognition core terms

This discourse leads to a  [selection of core cognition key concepts](../CC-Key-Concepts) with definitions.

Next: [Coping and co-creation](/coping-and-co-creation)
