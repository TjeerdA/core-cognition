...
Header:
  heading: "Conclusions"
  summary: "We derived key features of cognition from the properties of life and applied them to separate two main cognitive modes in their associated cognitive ontologies. We applied different levels of adequacy in coping and co-creation to first explain the structure of identity and secondly to compare two strategies to improve general well-being. In our efforts we show that it is possible to counteract the fragmentation of knowledge psychology tends to produce."
Media:
  featuredimage: "cover.jpg"
  alt: ""

Tags : ["concepts","basics", 'science']
...
## From fragmenting to unifying understanding
